...
\begin{figure}[htbp]
    \begin{subfigure}[htbp]{0.5\textwidth} 
        \includegraphics[width=\textwidth, keepaspectratio]{figures/traj_fig.pdf} 
        \caption{Planar view of landing trajectory\label{fig:true_landing_trajectory}} 
    \end{subfigure}~
    \begin{subfigure}[htbp]{0.5\textwidth} 
        \includegraphics[width=\textwidth, keepaspectratio]{figures/pos_fig.pdf} 
        \caption{Position of spacecraft in the inertial frame\label{fig:pos_components}} 
    \end{subfigure} 
...
\begin{figure}[htbp]
    \begin{subfigure}[htbp]{0.5\textwidth} 
        \includegraphics[width=\textwidth, keepaspectratio]{figures/orbslam_mappoints.png} 
        \caption{ORB-SLAM2 Feature Tracking Visualization\label{fig:orbslam_mappoints}} 
    \end{subfigure}~
    \begin{subfigure}[htbp]{0.5\textwidth} 
        \includegraphics[width=\textwidth, keepaspectratio]{figures/orbslam_localization.png} 
        \caption{ORB-SLAM2 Localization from monocular images \label{fig:orbslam_localization}} 
    \end{subfigure} 
\end{figure}
% TODO: Plots of trajectory

% TODO: Control input plot
% TODO: Show estimation from SLAM
