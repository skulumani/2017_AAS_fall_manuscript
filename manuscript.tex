...
A camera is simulated within blender with the following parameters, which are chosen to emulate the primary sensor of the NEAR spacecraft~\cite{hawkins1997}.
\begin{table}
    \centering
\begin{tabular}{llr}  
\toprule
...
\bottomrule
\end{tabular}
\caption{Camera parameters used in simulation}
\end{table}
