...
We implement a form of visual odometry to estimate the attitude and position of the spacecraft from a series of moncular imagery.

% TODO: Cite ORB-SLAM2 paper
% TODO: Give a brief overview of the method

One first step is to enable autonomous navigation and control 

Use image sensors for localization and can extend to mapping

We demonstrate the ability to estimate location using monocular images
\begin{figure}[htbp]
    \centering
...
% TODO: Describe teh landing trajectory - vertical descent in the body fixed frame
% TODO: Show desired attitude control for nadir pointing
